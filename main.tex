...
\newtcolorbox{myformula}{colback=block-gray,boxrule=0pt,boxsep=0pt,breakable,halign= flush left,before skip=15pt, after skip=5pt}
...
\newpage
\section{Security properties applied to Virtual Network migration}
