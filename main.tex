...
\input{sota-netvirt-sdn/existing_nhv.tex}

\input{sota-netvirt-sdn/nhv_refarchi.tex}

\input{sota-netvirt-sdn/summary_refarchi.tex}

\input{sota-netvirt-sdn/refarchi_table.tex}

\input{sota-netvirt-sdn/existing_vnmigration.tex}

\subsection{Security of VM migration}

\input{sota-VM/attacking_vmmigration.tex}

\subsection{Formal Models for network security}

\input{sota-FM/existing_formalmodels.tex}
...
\input{sota-RA/LP.tex}
\input{sota-RA/GT.tex}
\input{sota-RA/MDP.tex}

\newpage
\section{Model}
\subsection{Motivation}
\input{model/motivation.tex}

\subsection{Assumptions and simplifications}
\input{model/assumptions.tex}

\subsection{Modeling physical and virtual networks}
\input{model/model_networks.tex}

\subsection{Modeling the migration of Virtual Networks}
\input{model/model_migration.tex}

\subsection{Security properties applied to Virtual Network migration}
\input{model/security_properties.tex}

\subsection{Attacks against Migration}
\input{model/attack_model.tex}


\subsection{Monitoring Tools}

\input{model/monitoring_tools.tex}
