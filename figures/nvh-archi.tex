...
\draw (248,527.83) node  {\includegraphics[width=52.5pt,height=52.5pt]{figures/router-29825_1280.png}};
%Image [id:dp4786061414756648] 
\draw (248,407.83) node  {\includegraphics[width=52.5pt,height=52.5pt]{figures/router-29825_1280.png}};

%Image [id:dp9691436731399989] 
\draw (365.5,467.83) node  {\includegraphics[width=52.5pt,height=52.5pt]{figures/router-29825_1280.png}};
%Image [id:dp9494715890151124] 
\draw (130.5,467.83) node  {\includegraphics[width=52.5pt,height=52.5pt]{figures/router-29825_1280.png}};
...
\draw  [dash pattern={on 4.5pt off 4.5pt}]  (262.5,141.33) -- (263.5,187.83) ;


%Straight Lines [id:da5811563165265446] 
\draw  [dash pattern={on 4.5pt off 4.5pt}]  (119,271.83) -- (119,217.83) ;


%Straight Lines [id:da36813314079504633] 
\draw  [dash pattern={on 4.5pt off 4.5pt}]  (160.6,267.22) -- (210.83,212.62) ;


%Straight Lines [id:da7736079542900215] 
\draw  [dash pattern={on 4.5pt off 4.5pt}]  (263,219.83) -- (263,287.83) ;


%Straight Lines [id:da5692634255089728] 
\draw  [dash pattern={on 4.5pt off 4.5pt}]  (182,204.33) -- (210,203.33) ;


%Straight Lines [id:da11917773489604144] 
\draw  [dash pattern={on 4.5pt off 4.5pt}]  (179.78,258.44) -- (342.44,255.11) ;


%Straight Lines [id:da7770404819607903] 
\draw  [dash pattern={on 4.5pt off 4.5pt}]  (262.79,319.31) -- (263,354.33) ;


%Straight Lines [id:da8379163771385384] 
\draw  [dash pattern={on 4.5pt off 4.5pt}]  (146,270.33) -- (145.44,352.78) ;


%Straight Lines [id:da7179548819350594] 
\draw  [dash pattern={on 4.5pt off 4.5pt}]  (263,69.33) -- (263,109.33) ;
...
\draw  [dash pattern={on 4.5pt off 4.5pt}]  (325,140.83) -- (324.78,287.78) ;


%Straight Lines [id:da055910518428688105] 
\draw  [dash pattern={on 4.5pt off 4.5pt}]  (185.78,140.44) -- (185.72,239.92) ;


%Straight Lines [id:da9613526114203358] 
\draw  [dash pattern={on 4.5pt off 4.5pt}]  (66.44,218.44) -- (65.78,295.78) -- (172.05,294.22) ;


%Straight Lines [id:da3742893196331808] 
\draw  [dash pattern={on 4.5pt off 4.5pt}]  (348,140.83) -- (347.78,287.78) ;
...
\draw  [color={rgb, 255:red, 208; green, 2; blue, 27 }  ,draw opacity=1 ] (349.55,152.75) .. controls (349.55,148.91) and (352.96,145.8) .. (357.18,145.8) .. controls (361.39,145.8) and (364.8,148.91) .. (364.8,152.75) .. controls (364.8,156.59) and (361.39,159.7) .. (357.18,159.7) .. controls (352.96,159.7) and (349.55,156.59) .. (349.55,152.75) -- cycle ;
%Shape: Ellipse [id:dp13460717561019953] 
\draw  [color={rgb, 255:red, 208; green, 2; blue, 27 }  ,draw opacity=1 ] (189.3,196.34) .. controls (189.3,192.5) and (192.71,189.39) .. (196.93,189.39) .. controls (201.14,189.39) and (204.55,192.5) .. (204.55,196.34) .. controls (204.55,200.17) and (201.14,203.28) .. (196.93,203.28) .. controls (192.71,203.28) and (189.3,200.17) .. (189.3,196.34) -- cycle ;
...
\draw  [color={rgb, 255:red, 208; green, 2; blue, 27 }  ,draw opacity=1 ] (349.5,280.22) .. controls (349.5,275.65) and (353.55,271.95) .. (358.55,271.95) .. controls (363.55,271.95) and (367.6,275.65) .. (367.6,280.22) .. controls (367.6,284.78) and (363.55,288.48) .. (358.55,288.48) .. controls (353.55,288.48) and (349.5,284.78) .. (349.5,280.22) -- cycle ;
...
% Text Node
\draw (106.66,137.09) node [scale=0.9] [align=left] {Network Hypervisor};
% Text Node
...
% Text Node
\draw (272.76,157.2) node [scale=0.9,color={rgb, 255:red, 208; green, 2; blue, 27 }  ,opacity=1 ] [align=left] {2};
% Text Node
\draw (314.51,151.95) node [scale=0.9,color={rgb, 255:red, 208; green, 2; blue, 27 }  ,opacity=1 ] [align=left] {4};
% Text Node
\draw (356.51,153.45) node [scale=0.9,color={rgb, 255:red, 208; green, 2; blue, 27 }  ,opacity=1 ] [align=left] {5};
% Text Node
\draw (197.26,196.03) node [color={rgb, 255:red, 208; green, 2; blue, 27 }  ,opacity=1 ] [align=left] {6};
% Text Node
\draw (207.26,228.7) node [scale=0.9,color={rgb, 255:red, 208; green, 2; blue, 27 }  ,opacity=1 ] [align=left] {7};
% Text Node
\draw (272.06,229.3) node [scale=0.9,color={rgb, 255:red, 208; green, 2; blue, 27 }  ,opacity=1 ] [align=left] {8};
% Text Node
\draw (238.06,248.97) node [scale=0.9,color={rgb, 255:red, 208; green, 2; blue, 27 }  ,opacity=1 ] [align=left] {9};
% Text Node
\draw (130.15,228.62) node [scale=0.9,color={rgb, 255:red, 208; green, 2; blue, 27 }  ,opacity=1 ] [align=left] {{\small 10}};
% Text Node
\draw (77.35,284.22) node [color={rgb, 255:red, 208; green, 2; blue, 27 }  ,opacity=1 ] [align=left] {{\small 11}};
% Text Node
\draw (157.55,280.62) node [scale=0.9,color={rgb, 255:red, 208; green, 2; blue, 27 }  ,opacity=1 ] [align=left] {{\small 12}};
% Text Node
\draw (358.55,280.22) node [color={rgb, 255:red, 208; green, 2; blue, 27 }  ,opacity=1 ] [align=left] {{\small 13}};
% Text Node
...
% Text Node
\draw (160.93,11.75) node [scale=0.9,color={rgb, 255:red, 0; green, 0; blue, 0 }  ,opacity=1 ] [align=left] {Tenants};
% Text Node
...
% Text Node
\draw (143.66,363.17) node [scale=0.9] [align=left] {Physical Infrastructure};
