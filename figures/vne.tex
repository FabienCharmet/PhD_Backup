...
\draw (327,120.5) node  {\includegraphics[width=52.5pt,height=52.5pt]{figures/router-158644_1280.pdf}};
%Image [id:dp370061399936939] 
\draw (412.5,120.5) node  {\includegraphics[width=52.5pt,height=52.5pt]{figures/router-158644_1280.pdf}};
%Image [id:dp4531875445870204] 
\draw (502,120.5) node  {\includegraphics[width=52.5pt,height=52.5pt]{figures/router-158644_1280.pdf}};
...
\draw (81,154.5) node  {\includegraphics[width=52.5pt,height=52.5pt]{figures/router-29825_1280.pdf}};
%Image [id:dp7802067738931798] 
\draw (185,100.5) node  {\includegraphics[width=52.5pt,height=52.5pt]{figures/router-29825_1280.pdf}};
...
\draw (156,208.5) node  {\includegraphics[width=52.5pt,height=52.5pt]{figures/router-29825_1280.pdf}};
...
\draw (90,342.5) node  {\includegraphics[width=52.5pt,height=52.5pt]{figures/router-30140_1280.pdf}};
%Image [id:dp8001089418713573] 
\draw (180,373.5) node  {\includegraphics[width=52.5pt,height=52.5pt]{figures/router-30140_1280.pdf}};
%Image [id:dp9285996053263255] 
\draw (220,310.5) node  {\includegraphics[width=52.5pt,height=52.5pt]{figures/router-30140_1280.pdf}};
%Image [id:dp3146785253004203] 
\draw (406,324.5) node  {\includegraphics[width=52.5pt,height=52.5pt]{figures/router-30140_1280.pdf}};
%Image [id:dp3289010965024106] 
\draw (535,313.5) node  {\includegraphics[width=52.5pt,height=52.5pt]{figures/router-30140_1280.pdf}};
%Image [id:dp13463717449619406] 
\draw (535,386.5) node  {\includegraphics[width=52.5pt,height=52.5pt]{figures/router-30140_1280.pdf}};
