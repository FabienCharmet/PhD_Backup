...
\draw (297,257.5) node  {\includegraphics[width=52.5pt,height=52.5pt]{figures/router-158644_1280.png}};
%Image [id:dp9036637747838848] 
\draw (382.5,257.5) node  {\includegraphics[width=52.5pt,height=52.5pt]{figures/router-158644_1280.png}};
%Image [id:dp5664602004547369] 
\draw (472,257.5) node  {\includegraphics[width=52.5pt,height=52.5pt]{figures/router-158644_1280.png}};
...
\draw (61,213.5) node  {\includegraphics[width=52.5pt,height=52.5pt]{figures/router-29825_1280.png}};
%Image [id:dp21454722941873827] 
\draw (166,192.5) node  {\includegraphics[width=52.5pt,height=52.5pt]{figures/router-29825_1280.png}};
%Straight Lines [id:da6563559723871784] 
\draw    (81,229.17) -- (138,254.67) ;


%Image [id:dp06912306094485043] 
\draw (136,267.5) node  {\includegraphics[width=52.5pt,height=52.5pt]{figures/router-29825_1280.png}};
...
\draw (312,447.5) node  {\includegraphics[width=52.5pt,height=52.5pt]{figures/router-30140_1280.png}};
%Image [id:dp7997025451564928] 
\draw (461,423.67) node  {\includegraphics[width=52.5pt,height=52.5pt]{figures/router-30140_1280.png}};
%Image [id:dp22576183582057285] 
\draw (453,480.5) node  {\includegraphics[width=52.5pt,height=52.5pt]{figures/router-30140_1280.png}};
