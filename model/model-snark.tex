...
Since first-order theorem proving is undecidable (Trakhtenbrot's theorem) \FC{apparemment c'est de notoriété commune que la logique du premier ordre est indécidable, apparemment on est pas sur une connaissance de niche} and the search can go on forever, we give SNARK a time limit on proving a given theorem. 
