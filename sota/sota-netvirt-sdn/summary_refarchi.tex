...
Only Compositional Hypervisor~\cite{CompositionalHypervisor-Jin2014} does not properly virtualize the dataplane\GB{often found in two words in your manuscript.} and interacts with it using OpenFlow~\cite{Openflow-McKeown2008}.
