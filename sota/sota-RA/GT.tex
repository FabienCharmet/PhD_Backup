...
\paragraph{Solving the game}\textbf{\\}
...
\paragraph{Game Theory based Resource Allocation}
...
This work focuses on modelling intentional faults due to attacks, since accidental faults have different statistical properties such has randomness, faults are independent from each other \etc
