...
\begin{enumerate}
    ...
    \item Evaluate the policy
        \begin{algorithm}
            ...
            \tcc{Repeat until convergence of the value}
            }
        \end{algorithm}
    \item Improve policy
    \begin{algorithm}
...
\multicolumn{5}{|c|}{\textbf{Allocation requests management}}                                                                                                             \\ \hline
...
\multicolumn{5}{|c|}{\textbf{Resource allocation optimization}}                                                                                                           \\ \hline
