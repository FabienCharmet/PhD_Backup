...
Chevalier~\etal~\cite{HLPSL-Chevalier2004}       & X & X &   &    & X           & Network       & Communication protocol \\ \hline
Reitblatt~\etal~\cite{abstraction-reitblatt2012} &   &   &   & X  & X           & Network       & Network configuration  \\ \hline
Matousek~\etal~\cite{Matousek2008}              &   &   &   & X  &             & Network       & Network configuration  \\ \hline
Ou~\etal~\cite{mulval-Ou2013}             & X & X & X & X  & X           & Global infra. & CVE                    \\ \hline
Morin~\etal~\cite{M2D2-Morin2002}            & X & X & X & X  & X           & Global infra. & CVE                    \\ \hline
Cuppens~\etal~\cite{orbac}                     &   &   &   & X  &             & Global infra. & Security policy        \\ \hline
\end{tabular}%
}
