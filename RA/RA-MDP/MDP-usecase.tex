...
The reward of each monitoring node is computed the same way, by summing the expected value of each absorbing state containing the node.\\
...
\textbf{Fullmesh topology: Scenarios c) and d) \\}
